...
impl Mover {
    ...
    pub fn render_trail(&self, draw: &mut Draw) {
        draw.line(((TRAIL_TEX_WIDTH as f32 / 4. + self.pos.x), (0.0 + self.pos.y)), ((TRAIL_TEX_WIDTH as f32 / 4. + self.delta_pos.x), (0. + self.delta_pos.y))).width(1.).color(self.trail_color);
    }
